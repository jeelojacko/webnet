- [x] Survey CAD parcel auto frontage-path batch (July 2026): stop auto layout from inventing lots off non-selected remainder boundary/frontage edges, suppress over-aggressive angled-corner prepass bundles that created wonky far-left lot linework, keep multi-edge max-depth leftover frontage as remainder instead of folding it into oversized blue lots, and lock it with focused engine/workspace fixtures plus full validation.
