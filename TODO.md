- [x] Survey CAD parcel auto frontage-path batch (July 2026): stop auto layout from inventing lots off non-selected remainder boundary/frontage edges, tighten angled-corner handling for screenshot-style chained frontage, and lock it with focused engine/workspace fixtures plus full validation.
