- [ ] Map view under-400 continuation (July 2026): keep splitting the map-view root until the remaining implementation shell is under 400 lines before moving to another oversized source file; preserve 2D/3D interaction, planning controls, and renderer behavior.
