...
import { buildAuditDocs } from '../src/ai/studyAiUnitCalibrationAudit';
import { renderAllMarkdown } from '../src/ai/studyAiUnitCalibrationAudit.markdown';
import { coverageFlagsOf, riskCategoryFor, RISK_CATEGORY_LABELS } from '../src/ai/studyAiUnitCalibrationAudit.utils';
import { gapRowsFor } from '../src/ai/studyAiUnitCalibrationAudit';
import type { JobAuditRecord } from '../src/ai/studyAiUnitCalibrationAudit.types';
...
const buildFixture = (): { root: string; fixture: FixtureJobs } => {
  ...
  writeText(
    ...
    JSON.stringify({
      ...
      packagePath: studyTestContentPath('packages', 'nb-sit-statute-corpus.content-package.json'),
      promptSpecVersion: 'unit-authoring-v4',
