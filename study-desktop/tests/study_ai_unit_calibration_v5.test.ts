 ...
 * (`study-desktop/src/ai/studyAiUnitCalibrationV5.ts`).
 *
...
import { RUNS_DIR_REL } from '../src/ai/studyAiMapFreezeGate';
import { canonicalRunDir, FROZEN_MAP_RUN_ID } from '../src/ai/studyAiMapFreezeGate';
import type { AiUnitAuthoringJob } from '../src/ai/studyAiTypes';
import type { AiSuggestedPriority } from '../src/ai/studyAiTypes';
import type { AiSourceContentFlags } from '../src/ai/studyAiTypes';
import {
  CAL80_V4_RUN_ID,
  V5_PREFLIGHT_RUN_ID,
...
} from '../src/ai/studyAiUnitCalibrationV5';
import {
  buildV4V5CrosswalkReport,
  buildV4V5CrosswalkRows,
} from '../src/ai/studyAiUnitCalibrationV5Report';
import { renderV4V5CrosswalkReportMd } from '../src/ai/studyAiUnitCalibrationV5Report';
