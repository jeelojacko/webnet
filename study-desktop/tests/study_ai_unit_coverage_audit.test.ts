 ...
 * (study-desktop/src/ai/studyAiUnitCoverageAudit.ts).
 *
...
import type { AiStudyUnitProposal } from '../src/ai/studyAiTypes';
import {
...
} from '../src/ai/studyAiUnitCoverageAudit';
import type { CoverageWarningInstance } from '../src/ai/studyAiUnitCoverageAudit';
