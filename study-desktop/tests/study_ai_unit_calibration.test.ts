...
import {
  ...
  canonicalRunDir,
} from '../src/ai/studyAiMapFreezeGate';
import {
...
} from '../src/ai/studyAiUnitCalibration';
import { buildUnitCalibrationJobTags, classifyDomainByDocumentTitle } from '../src/ai/studyAiUnitCalibrationFeatures';
import { runUnitCalibration80, type UnitCalibration80Success } from '../src/ai/studyAiUnitCalibrationRun';
import { buildUnitCalibration80Report } from '../src/ai/studyAiUnitCalibrationReport';
import { readJsonFile } from '../src/ai/studyAiMapFreezeGate';
...
const realPreflightDir = studyTestContentPath( 'ai', 'runs', 'ai-units-2026-09-02-frozen-map-v4-preflight');
const realPackage = studyTestContentPath('packages', 'nb-sit-statute-corpus.content-package.json');
