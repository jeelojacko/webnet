...
export const CadVolumeSection: React.FC<CadVolumeSectionProps> = ({
  ...
  return (
    <>
      ...
      <VolumeStyleSettings snapshot={snapshot} actions={actions} setNotice={setNotice} />
    </>
  );
};
...
/** Bounded style CRUD (New/Duplicate/Rename/Delete/Edit), refcount-guarded delete. */
const VolumeStyleSettings: React.FC<{
  snapshot: CadWorkspaceSnapshot;
  actions: CadShellActions;
  setNotice: (_notice: string) => void;
