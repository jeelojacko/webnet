    ...
    <div className="border-b border-slate-800 bg-slate-900/70 px-4 py-3">
      ...
      {comparisonSummary && (
        <div className="mt-3 grid gap-3 xl:grid-cols-[1.1fr_1fr_1fr]">
          ...
          <div className="rounded border border-slate-800 bg-slate-950/40 p-3">
            <div className="mb-2 text-[11px] uppercase tracking-wide text-slate-500">Moved Stations</div>
          ...
          <div className="rounded border border-slate-800 bg-slate-950/40 p-3">
            <div className="mb-2 text-[11px] uppercase tracking-wide text-slate-500">Residual Deltas</div>
