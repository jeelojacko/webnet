export const getReportHeaderTooltip = (rawLabel: string): string | undefined => {
  ...
  const tips: Record<string, string> = {
    ...
    SCORE: 'Heuristic ranking score used to prioritize likely suspect rows (deterministic ordering aid only, not a statistical test).',
    STATUS: 'Pass/warn classification against configured closure thresholds.',
    SEVERITY: 'Relative closure-risk score used to rank suspect loops (deterministic ordering aid only, not a statistical test).',
