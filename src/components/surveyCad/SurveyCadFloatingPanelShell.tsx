...
const shellClassName =
  'pointer-events-auto fixed z-40 overflow-hidden rounded border border-slate-700 bg-slate-950/95 shadow-2xl backdrop-blur';
    ...
    <div className={shellClassName} style={positionStyle} {...shellProps}>
      ...
      >
        <div className="min-w-0">
          ...
          {subtitle ? (
            <div className="text-[9px] leading-4 text-slate-400">{subtitle}</div>
          ) : null}
        </div>
