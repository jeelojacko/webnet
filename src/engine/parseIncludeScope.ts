...
const cloneScopedParseState = (state: ParseOptions): Partial<ParseOptions> => ({
  ...
  gpsWeightingMode: state.gpsWeightingMode,
  gpsVectorFactorHorizontal: state.gpsVectorFactorHorizontal,
  gpsVectorFactorVertical: state.gpsVectorFactorVertical,
  gnssVectorFrameDefault: state.gnssVectorFrameDefault,
  gnssFrameConfirmed: state.gnssFrameConfirmed,
  verticalDeflectionNorthSec: state.verticalDeflectionNorthSec,
  verticalDeflectionEastSec: state.verticalDeflectionEastSec,
