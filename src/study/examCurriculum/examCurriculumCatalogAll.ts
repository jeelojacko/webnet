// Exam Curriculum V1 — canonical catalog composition (A → B → C → D → NAV).
//
// Composes the frozen Tier-A (51), Tier-B (43), Tier-C (21) and Tier-D (6)
// spec lists with the new cross-document Navigation catalog (12) into the
// single deterministic catalog the builder, reports and tests consume.
// Canonical manifest order: Tier A (indexes 0-50), Tier B (51-93), Tier C
// (94-114), Tier D (115-120), Navigation (121-132); total 133 units.
...
export const EXAM_CURRICULUM_TOTAL = 133;

/** Tier-A (51) + Tier-B (43) + Tier-C (21) + Tier-D (6) + Navigation (12). */
