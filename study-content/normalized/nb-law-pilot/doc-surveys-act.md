...
Citation: 2011, c.226
Document ID: doc-surveys-act
Source: https://laws.gnb.ca/en/document/cs/2011%2C%20c.226
...
(i)
the coordinate monuments established, and
...
(i)
any coordinate monuments not affected,

(ii)
any coordinate monuments destroyed,

(iii)
any additional coordinate monuments established, and
...
(a)
the values of the six New Brunswick Canadian Base Network stations set out in this schedule, or

(b)
the values of the densification of the Canadian Base Network carried out by Service New Brunswick for the purpose of establishing the New Brunswick High Precision Network.
