...
Citation: REGULATION 84-190
Document ID: reg-registry-84-190
Source: https://laws.gnb.ca/en/document/cr/84-190
...
1 This Regulation may be cited as the Instrument Standards Regulation - Registry Act .
...
( a)
with respect to a digitally scanned image of an instrument referred to in subsection (3), if the instrument is not of sufficient clarity to be readable by the registrar when reproduced, or

( b)
with respect to a digitally scanned image of an instrument referred to in subsection (4), if the seal cannot be identified by the registrar.
...
3 New Brunswick Regulation 84-114 under the Registry Act is repealed.

### 4

Source key: section:4

4 Sections 1 and 2 of this Regulation come into force on January 7, 1985.
