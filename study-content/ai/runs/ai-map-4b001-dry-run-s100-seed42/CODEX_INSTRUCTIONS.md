...
Process ONLY the requested content job files in study-content\ai\runs\ai-map-4b001-dry-run-s100-seed42/jobs using study-content/ai/specs/study-map-v2.md.
