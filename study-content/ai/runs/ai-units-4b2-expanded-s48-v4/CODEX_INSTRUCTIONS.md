...
Process ONLY the requested content job files in study-content\ai\runs\ai-units-4b2-expanded-s48-v4/jobs using study-content/ai/specs/unit-authoring-v4.md.
...
Follow promptSpecVersion unit-authoring-v4.
