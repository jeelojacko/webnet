...
describe('Canada CRS catalog (Phase 2 expansion)', () => {
  it('keeps default UTM id and includes MTM + provincial entries', () => {
    ...
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AR_NORTH')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AR_NORTH_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AR_SOUTH')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AR_SOUTH_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_OK_NORTH')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_OK_NORTH_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_OK_SOUTH')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_OK_SOUTH_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_1')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_2')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_3')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_4')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_5')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_6')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_7')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_8')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_9')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AK_ZONE_10')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_MI_NORTH')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_MI_CENTRAL')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_MI_SOUTH')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_ND_NORTH')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_ND_SOUTH')).toBe(true);
    ...
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AZ_EAST_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AZ_CENTRAL_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_AZ_WEST_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_MI_NORTH_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_MI_CENTRAL_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_MI_SOUTH_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_MT')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_MT_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_NY_LONG_ISLAND')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_NY_LONG_ISLAND_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_ND_NORTH_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_ND_SOUTH_FTUS')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_PR_VI')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_SC')).toBe(true);
    expect(CRS_CATALOG.some((row) => row.id === 'US_NAD83_2011_SPCS_SC_FTUS')).toBe(true);
  });
  ...
  it('resolves CRS by canonical id and EPSG aliases', () => {
    ...
    const byUsArNorth = getCrsDefinition('EPSG:6410');
    const byUsArNorthFt = getCrsDefinition('6411');
    const byUsArSouth = getCrsDefinition('EPSG:6412');
    const byUsArSouthFt = getCrsDefinition('6413');
    const byUsOkNorth = getCrsDefinition('EPSG:6552');
    const byUsOkNorthFt = getCrsDefinition('6553');
    const byUsOkSouth = getCrsDefinition('EPSG:6554');
    const byUsOkSouthFt = getCrsDefinition('6555');
    const byUsAkZone1 = getCrsDefinition('EPSG:6394');
    const byUsAkZone2 = getCrsDefinition('6395');
    const byUsAkZone3 = getCrsDefinition('EPSG:6396');
    const byUsAkZone4 = getCrsDefinition('6397');
    const byUsAkZone5 = getCrsDefinition('EPSG:6398');
    const byUsAkZone6 = getCrsDefinition('6399');
    const byUsAkZone7 = getCrsDefinition('EPSG:6400');
    const byUsAkZone8 = getCrsDefinition('6401');
    const byUsAkZone9 = getCrsDefinition('EPSG:6402');
    const byUsAkZone10 = getCrsDefinition('6403');
    const byUsMiNorth = getCrsDefinition('EPSG:6495');
    const byUsMiCentral = getCrsDefinition('6493');
    const byUsMiSouth = getCrsDefinition('EPSG:6498');
    const byUsNdNorth = getCrsDefinition('6544');
    const byUsNdSouth = getCrsDefinition('EPSG:6546');
    ...
    const byUsAzEastFt = getCrsDefinition('6407');
    const byUsAzCentralFt = getCrsDefinition('EPSG:6405');
    const byUsAzWestFt = getCrsDefinition('6409');
    const byUsMiNorthFt = getCrsDefinition('6496');
    const byUsMiCentralFt = getCrsDefinition('EPSG:6494');
    const byUsMiSouthFt = getCrsDefinition('6499');
    const byUsMt = getCrsDefinition('EPSG:6514');
    const byUsMtFt = getCrsDefinition('6515');
    const byUsNyLongIsland = getCrsDefinition('EPSG:6538');
    const byUsNyLongIslandFt = getCrsDefinition('6539');
    const byUsNdNorthFt = getCrsDefinition('EPSG:6545');
    const byUsNdSouthFt = getCrsDefinition('6547');
    const byUsPrVi = getCrsDefinition('EPSG:6566');
    const byUsSc = getCrsDefinition('6569');
    const byUsScFt = getCrsDefinition('EPSG:6570');
    ...
    expect(byUsArNorth?.id).toBe('US_NAD83_2011_SPCS_AR_NORTH');
    expect(byUsArNorthFt?.id).toBe('US_NAD83_2011_SPCS_AR_NORTH_FTUS');
    expect(byUsArSouth?.id).toBe('US_NAD83_2011_SPCS_AR_SOUTH');
    expect(byUsArSouthFt?.id).toBe('US_NAD83_2011_SPCS_AR_SOUTH_FTUS');
    expect(byUsOkNorth?.id).toBe('US_NAD83_2011_SPCS_OK_NORTH');
    expect(byUsOkNorthFt?.id).toBe('US_NAD83_2011_SPCS_OK_NORTH_FTUS');
    expect(byUsOkSouth?.id).toBe('US_NAD83_2011_SPCS_OK_SOUTH');
    expect(byUsOkSouthFt?.id).toBe('US_NAD83_2011_SPCS_OK_SOUTH_FTUS');
    expect(byUsAkZone1?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_1');
    expect(byUsAkZone2?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_2');
    expect(byUsAkZone3?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_3');
    expect(byUsAkZone4?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_4');
    expect(byUsAkZone5?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_5');
    expect(byUsAkZone6?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_6');
    expect(byUsAkZone7?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_7');
    expect(byUsAkZone8?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_8');
    expect(byUsAkZone9?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_9');
    expect(byUsAkZone10?.id).toBe('US_NAD83_2011_SPCS_AK_ZONE_10');
    expect(byUsMiNorth?.id).toBe('US_NAD83_2011_SPCS_MI_NORTH');
    expect(byUsMiCentral?.id).toBe('US_NAD83_2011_SPCS_MI_CENTRAL');
    expect(byUsMiSouth?.id).toBe('US_NAD83_2011_SPCS_MI_SOUTH');
    expect(byUsNdNorth?.id).toBe('US_NAD83_2011_SPCS_ND_NORTH');
    expect(byUsNdSouth?.id).toBe('US_NAD83_2011_SPCS_ND_SOUTH');
    ...
    expect(byUsAzEastFt?.id).toBe('US_NAD83_2011_SPCS_AZ_EAST_FTUS');
    expect(byUsAzCentralFt?.id).toBe('US_NAD83_2011_SPCS_AZ_CENTRAL_FTUS');
    expect(byUsAzWestFt?.id).toBe('US_NAD83_2011_SPCS_AZ_WEST_FTUS');
    expect(byUsMiNorthFt?.id).toBe('US_NAD83_2011_SPCS_MI_NORTH_FTUS');
    expect(byUsMiCentralFt?.id).toBe('US_NAD83_2011_SPCS_MI_CENTRAL_FTUS');
    expect(byUsMiSouthFt?.id).toBe('US_NAD83_2011_SPCS_MI_SOUTH_FTUS');
    expect(byUsMt?.id).toBe('US_NAD83_2011_SPCS_MT');
    expect(byUsMtFt?.id).toBe('US_NAD83_2011_SPCS_MT_FTUS');
    expect(byUsNyLongIsland?.id).toBe('US_NAD83_2011_SPCS_NY_LONG_ISLAND');
    expect(byUsNyLongIslandFt?.id).toBe('US_NAD83_2011_SPCS_NY_LONG_ISLAND_FTUS');
    expect(byUsNdNorthFt?.id).toBe('US_NAD83_2011_SPCS_ND_NORTH_FTUS');
    expect(byUsNdSouthFt?.id).toBe('US_NAD83_2011_SPCS_ND_SOUTH_FTUS');
    expect(byUsPrVi?.id).toBe('US_NAD83_2011_SPCS_PR_VI');
    expect(byUsSc?.id).toBe('US_NAD83_2011_SPCS_SC');
    expect(byUsScFt?.id).toBe('US_NAD83_2011_SPCS_SC_FTUS');
  });
