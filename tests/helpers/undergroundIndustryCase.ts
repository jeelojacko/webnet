...
import type { AdjustmentResult, Instrument, InstrumentLibrary, ParseOptions } from '../../src/types';

export const UNDERGROUND_INPUT_PATH = 'tests/fixtures/industry_case_underground_input.txt';
export const UNDERGROUND_WEBNET_OUTPUT_PATH = 'tests/fixtures/industry_case_underground_output.txt';
export const UNDERGROUND_INDUSTRY_OUTPUT_PATH =
  'tests/fixtures/industry_case_underground_industry_output.txt';

export const undergroundSettings: SettingsState = {
  maxIterations: 10,
...
export const s9Instrument: Instrument = {
  code: 'S9',
...
export const undergroundProjectInstruments: InstrumentLibrary = {
  S9: s9Instrument,
};
...
export const buildUndergroundCase = (): {
  ...
  const { resolveProfileContext, buildRunDiagnostics } = createRunProfileBuilders({
    projectInstruments: undergroundProjectInstruments,
