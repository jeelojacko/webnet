  ...
  if (sizeSkipReason != null) {
    return {
      ...
      routes: [
        ...
        { route: 'sparse-correction-only', status: 'skipped', skipReason: sizeSkipReason },
        { route: 'sparse-full-bundle', status: 'skipped', skipReason: sizeSkipReason },
        { route: 'sparse-full-selected-network', status: 'skipped', skipReason: sizeSkipReason },
      ],
    };
  }
