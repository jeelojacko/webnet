...
- `studyStorage.ts` for IndexedDB-backed metadata, progress, attempt, draft, scheduler-state, settings storage, on-demand legal-component repository lookups, and atomic rating/undo writes
