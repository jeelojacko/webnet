...
Phase 2E.4 keeps semantic regression locks for Surveys Act sections 2-6, Boundaries Confirmation Act sections 8, 10, 14 and 16, Community Planning Act sections 16, 79, 83 and 85, and Registry Act section 16. These golden sections prefer broad, accurate questions over unsupported specialized templates and include natural actor/action rubric prompts where the source text is clear.
