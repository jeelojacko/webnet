...
- default 2D survey symbols now use higher-contrast cyan / emerald / orange / red station colors and stronger blue ellipse/line accents so points and linework remain readable over the basemap instead of blending into beige or white map content
