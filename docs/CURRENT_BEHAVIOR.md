...
- a `Survey CAD` workspace tab that can be opened before any solve; it currently acts as the durable entry seam for CAD architecture docs plus the live native-model/renderer spike preview and adapter-inspection workflow
