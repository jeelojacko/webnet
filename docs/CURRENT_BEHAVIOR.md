...
- combined CRS catalog coverage is now 163 rows total: 57 Canada-first rows (16 UTM, 17 MTM, 24 provincial) plus 106 USA State Plane rows (`us-spcs`)
