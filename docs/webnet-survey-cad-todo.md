...
- [ ] Parcel tools batch: finish the remaining parcel-partition tools such as hinged/sliding area workflows after the current area-sequence, area-units, parcel-from-lines, split, gap/overlap, and parcel-table slices.
