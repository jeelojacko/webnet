...
- **Evidence** (`tests/evidence/phase8b1_preanalysis_release.test.ts`,
  ...
  `tests/evidence/phase10g_final_covariance_architecture.test.ts`): large repeated
