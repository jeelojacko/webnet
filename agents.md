...
- Current behavior also includes STAR-style weighted statistical summaries computed from per-observation `vTPv` contributions by family (Angles/Directions/Distances/etc.), with chi-square bounds surfaced in both error-factor and variance-factor forms in Processing Summary and listing/export views.
