...
- Open `Study` from the toolbar, or visit `/study`, for a separate local-first New Brunswick statute and survey-law study app. Its Manage page can import the generated official NB law content package for offline legal reading and source-linked study units.
