...
- UX/Map: optional 3D map architecture scaffold is now wired behind a feature flag (default OFF) with shared scene graph/camera primitives (`src/engine/map3d.ts`) ready for orbit/ellipsoid rendering phases.
