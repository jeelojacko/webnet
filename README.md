...
- Parser diagnostics: apostrophe-tagged station descriptions on `C/P/PH/CH/EH/E` records are now scanned and grouped by canonical station ID; parse state/logs now report repeated IDs and conflicting description text with source-line traceability.
