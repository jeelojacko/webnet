...
- Parser: Star*Net-style inline options (.UNITS/.COORD/.ORDER/.2D/.3D/.DELTA/.MAPMODE/.LWEIGHT/.NORMALIZE/.END) plus C/E/CH/PH/EH and D/A/G/L records with fixity/std errs and ft<->m normalization (P lat/long stored as degrees; projection pending); see TODO.md for remaining codes to support.
